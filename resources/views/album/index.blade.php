...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/album/indexAlbum.css') }}">
              ...
              ">
                        ...
                        <div class="info">
                            ...
                            <div style="margin-left: 20px;">
                                <a href="/albums/{{ $item->id }}/edit"><i class="fa fa-edit"></i></a>
                                <a href="/images/create?id={{ $item->id }}"><i class="fa fa-plus"></i></a>
                                <button style="background: none;border: none;cursor: pointer;"
                                    album_id={{ $item->id }} id='delete' class="delete_btn"><i
                                        class="fa fa-trash"></i></button>

                            </div>
                        </div>
                        <a class="plot" title="plot with jinkyu" href="/gallery/{{ $item->id }}">
                            view image →
                        </a>
                    </div>
                </div>
    ...
    <script>
        $(document).on('click', '.delete_btn', function(e) {
            ...
            if (choice) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: "{{ route('albums.destroy', ':id') }}".replace(':id', album_id),
                    data: {
                        '_token': "{{ csrf_token() }}",
                        'id': album_id,
                        'targetAlbumId': 1,
