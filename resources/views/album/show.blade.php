...
<body>
    ...
    </nav> <!-- Repeat this block for each item -->
    <div class="card">
        <div class="minip">
            <div class="mg">
                <div class="clr"></div>
            ...
            <div class="footer-content">
                ...
                <div class="footer-content-column">
                    <div class="footer-call-to-action">
                        ...
                        <a class="footer-call-to-action-button button" href="#" target="_self"> Get in
                            Touch
                        </a>
                    </div>
                    <div class="footer-call-to-action">
            ...
            <div class="footer-copyright">
                <div class="footer-copyright-wrapper">
                    <p class="footer-copyright-text">
                        <a class="footer-copyright-link" href="#" target="_self"> ©2020. | Designed By:
                            Pooja
