...
<body>
    ...
    <div class="c-formContainer">
        <form class="c-form" id="myForm" method="POST" action="/albums/{{ $album->id }}">
            @csrf
            @method('put')
            <div>
                <div class="c-form__group">
                    <label class="c-form__label" for="username">
                        ...
                        <span class="c-form__groupLabel">Edit Album username.</span>
    ...
    <!---------------scripts --------------->
    <script src="{{ asset('js/album/editAlbum.js') }}"></script>
