...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/image/create.css') }}">
...
">
    ...
    <form method="post" action="/gallery/store" style="border-color:2px solid aqua"enctype="multipart/form-data">
        @csrf
        <div class="input-file-container">
            <input class="input-file" id="my-file" type="file" name="path" required>
    ...
    <script src="{{ asset('js/image/create.js') }}"></script>
